# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-06-21 19:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_type', models.CharField(choices=[('CALL_ME', 'Call me'), ('WEB', 'Web'), ('SMS_SPAM', 'SMS (SPAM)'), ('RING', 'Ring.'), ('SMS', 'SMS'), ('CHARGE_ME', 'Top-up my account')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_on', models.DateTimeField(default=django.utils.timezone.now)),
                ('status', models.CharField(choices=[('IS_BUSY', 'Busy'), ('BLACK_LIST', 'Black listed'), ('NEW_REQUEST', 'New'), ('GAVE_UP', 'Gave up'), ('NOT_ANSWERING', 'Not answering'), ('HANDLED', 'Handled')], max_length=50)),
            ],
            options={
                'ordering': ('-created_on', '-id'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity_type', models.CharField(choices=[('state', 'State'), ('ward', 'Ward'), ('lga', 'LGA'), ('autre', 'Other')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('IS_BUSY', 'Busy'), ('BLACK_LIST', 'Black listed'), ('NEW_REQUEST', 'New'), ('GAVE_UP', 'Gave up'), ('NOT_ANSWERING', 'Not answering'), ('HANDLED', 'Handled')], default='NEW_REQUEST', max_length=50)),
                ('received_on', models.DateTimeField()),
                ('event_type', models.CharField(choices=[('CALL_ME', 'Call me'), ('WEB', 'Web'), ('SMS_SPAM', 'SMS (SPAM)'), ('RING', 'Ring.'), ('SMS', 'SMS'), ('CHARGE_ME', 'Top-up my account')], max_length=50)),
                ('sms_message', models.TextField(blank=True, null=True)),
                ...
                ('sex', models.CharField(choices=[('male', 'Male'), ('unknown', 'Unknown'), ('female', 'Female')], default='unknown', max_length=20, verbose_name='Gender')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_type', models.CharField(choices=[('boolean', 'True/False'), ('multi_choice', 'Multiple Choice List'), ('int', 'Number (integer)'), ('float', 'Number (float)'), ('choice', 'Choice List'), ('string', 'Short text'), ('date', 'Date'), ('text', 'Text')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ready', 'Ready'), ('created', 'Started'), ('disabled', 'Disabled')], default='created', max_length=50)),
            ],
            options={
                'ordering': ('id',),
            },
