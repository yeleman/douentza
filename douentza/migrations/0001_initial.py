# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-05-25 14:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_type', models.CharField(choices=[('CHARGE_ME', 'Top-up my account'), ('WEB', 'Web'), ('CALL_ME', 'Call me'), ('SMS', 'SMS'), ('SMS_SPAM', 'SMS (SPAM)'), ('RING', 'Ring.')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('status', models.CharField(choices=[('HANDLED', 'Handled'), ('GAVE_UP', 'Gave up'), ('IS_BUSY', 'Busy'), ('NOT_ANSWERING', 'Not answering'), ('BLACK_LIST', 'Black listed'), ('NEW_REQUEST', 'New')], max_length=50)),
            ],
            options={
                'ordering': ('-created_on', '-id'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity_type', models.CharField(choices=[('autre', 'Other'), ('state', 'State'), ('lga', 'LGA'), ('ward', 'Ward')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operator', models.CharField(choices=[('orange', 'Orange MALI'), ('malitel', 'Malitel'), ('foreign', 'Ext\xe9rieur')], max_length=50)),
                ('hotline_number', models.CharField(blank=True, max_length=30, null=True)),
                ('status', models.CharField(choices=[('HANDLED', 'Handled'), ('GAVE_UP', 'Gave up'), ('IS_BUSY', 'Busy'), ('NOT_ANSWERING', 'Not answering'), ('BLACK_LIST', 'Black listed'), ('NEW_REQUEST', 'New')], default='NEW_REQUEST', max_length=50)),
                ('received_on', models.DateTimeField()),
                ('event_type', models.CharField(choices=[('CHARGE_ME', 'Top-up my account'), ('WEB', 'Web'), ('CALL_ME', 'Call me'), ('SMS', 'SMS'), ('SMS_SPAM', 'SMS (SPAM)'), ('RING', 'Ring.')], max_length=50)),
                ('sms_message', models.TextField(blank=True, null=True)),
                ...
                ('duration', models.PositiveIntegerField(blank=True, help_text='Call duration (seconds)', max_length=4, null=True, verbose_name='Callback duration')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_type', models.CharField(choices=[('int', 'Number (integer)'), ('boolean', 'True/False'), ('string', 'Short text'), ('date', 'Date'), ('text', 'Text'), ('float', 'Number (float)'), ('multi_choice', 'Multiple Choice List'), ('choice', 'Choice List')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ready', 'Ready'), ('disabled', 'Disabled'), ('created', 'Started')], default='created', max_length=50)),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.AddField(
            model_name='hotlinerequest',
            name='tags',
            field=models.ManyToManyField(blank=True, null=True, related_name='requests', to='douentza.Tag', verbose_name='Tags'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='cluster',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='douentza.Cluster'),
        ),
        migrations.AddField(
            model_name='hotlineuser',
            name='groups',
