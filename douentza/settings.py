...
SECRET_KEY = 'stqvx4$1yc-(_wzgrzkn9g4jyt5s!$&b5j_uta+39xo76gg*_3'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'db_neri.sqlite3'),
    }
}
...
CACHEDDATA_FOLDER = os.path.join(BASE_DIR, 'cached_data')
